    ...
    .directive('dateRangePicker', function($timeout, DateRangePickerService, DateRangePickerLocaleService, $log) {
      ...
      return {
        ...
        link: function(scope, iElement, iAttrs, ngModelCtrl) {
          ...
          /**
           * Differs from "notEarlierThan" NgModelController.$validators. Purpose to check limit, rather than compare to endDate
           *
          ...
          /**
           * Differs from "notLaterThan" NgModelController.$validators. Purpose to check limit, rather than compare to startDate
           *
           * @param {Object} modelValue
           * @param {String} compareTo
           * @returns {Boolean}
