...
function AngularCtrl($scope, DateRangePickerLocaleService, DateRangePickerService) {
...
angular.module('app')
  .directive('nDatepicker', nDatepicker);

function nDatepicker(config) {
  return {
    restrict: 'E',
    scope: {
      identifier: '@',
...
angular.module("app")
  .directive('nDateRangepicker', nDateRangepicker);

function nDateRangepicker(config) {
  return {
    restrict: 'E',
    scope: {
      identifier: '@',
...
angular.module('app')
  .controller('jQueryCtrl', jQueryCtrl);

function jQueryCtrl($scope) {
  $scope.jqueryDate = {};
